...
public static class Settings
{
    ...
    public static TimeSpan SeedDuration = TimeSpan.FromSeconds(RunDuration.TotalSeconds * Convert.ToDouble(ConfigurationManager.AppSettings["SeedDurationFactor"], CultureInfo.InvariantCulture));
}
