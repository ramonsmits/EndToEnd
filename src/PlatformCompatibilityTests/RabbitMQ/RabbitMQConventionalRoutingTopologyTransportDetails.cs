...
namespace ServiceControlCompatibilityTests
{
    ...
    public class RabbitMQConventionalRoutingTopologyTransportDetails : ITransportDetails
    {
        const string TransportTypeName = "NServiceBus.RabbitMQTransport, NServiceBus.Transports.RabbitMQ";

        public RabbitMQConventionalRoutingTopologyTransportDetails(string connectionString)
        {
